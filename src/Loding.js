...
const LodingPage = () => {
    ...
    return (
        <div className="loding-page drag-prevent">
            ...
            {showFirstMessage === 1 && <p>로딩중입니다...</p>}
            {showFirstMessage === 2 && <p>조금 더 기다려주세요. 곧 완료됩니다!</p>}
            {showFirstMessage === 3 && <p>잠시만 기다려주세요.</p>}
            {showFirstMessage === 4 && <p>서버가 힘들어하는 중입니다.</p>}
            {showFirstMessage === 5 && <p>잠시 후 다시 시도해주세요.</p>}
