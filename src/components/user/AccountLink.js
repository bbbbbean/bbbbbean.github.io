...
export default function AccountLink() {
  ...
  const handleNaverLink = (item) => {
    ...
    const url =
      ...
      "&redirect_uri=https://beeeen.store/mypage/account_link?platform=1" +
      "&state=STATE_STRING" +
      "&response_type=" +
      RESPONSE_TYPE;
  ...
  const handleKakaoLink = () => {
    ...
    const url =
      ...
      "&redirect_uri=https://beeeen.store/mypage/account_link?platform=2" +
      "&response_type=" +
      RESPONSE_TYPE;
  ...
  const handleGoogleLink = (item) => {
    const url =
      ...
      "&redirect_uri=https://beeeen.store/mypage/account_link?platform=3" +
      "&response_type=code" +
